...
@section('title', 'PIXEL FISH - BAIT & LURE GUIDE')

@section('content')
<header class="mb-margin-lg flex flex-col gap-4">
    <a href="{{ route('wiki.index') }}" class="text-white hover:text-[#97cbff] transition-colors flex items-center gap-2 font-label-sm w-fit uppercase bg-surface-container px-4 py-2 border-[2px] border-outline-variant">
...
<section class="border-4 border-black shadow-[8px_8px_0_0_#000] bg-surface-container p-0 overflow-hidden flex flex-col">
    <div class="bg-[#97cbff] text-black p-4 border-b-[4px] border-black flex items-center gap-4">
        <span class="material-symbols-outlined text-[32px] font-bold">set_meal</span>
