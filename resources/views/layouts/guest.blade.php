...
<body class="bg-background text-on-background font-body-md text-body-md min-h-screen flex flex-col items-center justify-center p-4">
    <main class="w-full max-w-4xl bg-surface-container border-[4px] border-black shadow-[8px_8px_0_0_#000] p-8 flex flex-col md:flex-row gap-8 mx-auto mt-20 relative overflow-hidden">
        ...
        <div class="flex-1 flex flex-col items-center justify-center space-y-8 text-center border-b-4 border-black pb-8 md:border-b-0 md:border-r-4 md:pr-8 md:pb-0">
            <div class="relative w-64 h-64 mb-4 border-[4px] border-black shadow-[4px_4px_0_0_#000] bg-surface-container-high overflow-hidden">
            ...
            <h1 class="font-headline-lg text-headline-lg text-primary tracking-widest drop-shadow-[2px_2px_0_rgba(0,0,0,1)] uppercase">PIXEL FISH</h1>
            <div class="border-[4px] border-outline-variant bg-surface-variant p-4 shadow-[4px_4px_0_0_#000] relative">
