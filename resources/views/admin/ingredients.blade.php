    ...
    <div class="lg:col-span-1">
        <div class="bg-surface border-[4px] border-black shadow-[8px_8px_0_0_#000] p-6 sticky top-24">
            ...
            <form action="{{ isset($ingredient) ? route('admin.ingredients.update', $ingredient) : route('admin.ingredients.store') }}" method="POST" class="flex flex-col gap-4">
                ...
                <button type="submit" name="{{ isset($ingredient) ? 'update_ing' : 'add_ing' }}" class="bg-[#ff6b6b] text-black font-bold border-[4px] border-black py-3 uppercase text-[10px]">
    ...
    <div class="lg:col-span-2">
        <div class="bg-surface-container border-[4px] border-black shadow-[8px_8px_0_0_#000] p-4 overflow-x-auto">
            <table class="w-full text-left border-4 border-black border-collapse bg-[#121519]">
                <thead class="bg-black text-[#ff6b6b] uppercase text-[10px]">
                    <tr>
                        <th class="p-3 border-b-4 border-r-4 border-black">MATERIAL</th>
                ...
                <tbody class="text-[12px] font-bold uppercase text-white">
                    ...
                    <tr class="border-b-4 border-black">
                        <td class="p-3 border-r-4 border-black text-[#ff6b6b]">{{ $row->ingredient_name }}</td>
                        <td class="p-3 text-center">
                            <div class="flex gap-2 justify-center">
                                <a href="{{ route('admin.ingredients.edit', $row) }}" class="bg-yellow-400 p-2 border-2 border-black text-black"><span class="material-symbols-outlined text-[16px]">edit</span></a>
