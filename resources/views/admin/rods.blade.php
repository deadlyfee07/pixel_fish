    ...
    <div class="lg:col-span-1">
        <div class="bg-surface border-[4px] border-black shadow-[4px_4px_0_0_#000] md:shadow-[8px_8px_0_0_#000] p-4 md:p-6 sticky top-24">
            ...
            <form action="{{ isset($rod) ? route('admin.rods.update', $rod) : route('admin.rods.store') }}" method="POST" class="flex flex-col gap-4">
                ...
                <button type="submit" class="bg-[#a8e040] text-black font-bold border-[4px] border-black py-3 uppercase text-[9px] md:text-[10px]">
    ...
    <div class="lg:col-span-2">
        <div class="bg-surface-container border-[4px] border-black shadow-[8px_8px_0_0_#000] p-4 overflow-x-auto">
            <table class="w-full text-left border-4 border-black border-collapse bg-[#121519]">
                <thead class="bg-black text-[#a8e040] uppercase text-[9px] md:text-[10px]">
                    <tr>
                        <th class="p-2 md:p-3 border-b-4 border-r-4 border-black">ROD & PATH</th>
                ...
                <tbody class="text-[10px] md:text-[12px] font-bold uppercase text-white">
                    ...
                    <tr class="border-b-4 border-black">
                        <td class="p-2 md:p-3 border-r-4 border-black">
                            <div class="text-[#a8e040] break-words">{{ $row->rod_name }}</div>
                            <div class="text-[#97cbff] text-[9px] md:text-[10px] break-words">{{ $row->upgrade_level }}</div>
                        </td>
                        <td class="p-2 md:p-3 text-center">
                            <div class="flex gap-1 md:gap-2 justify-center">
                                <a href="{{ route('admin.rods.edit', $row) }}" class="bg-yellow-400 p-1 md:p-2 border-2 border-black text-black"><span class="material-symbols-outlined text-[14px] md:text-[16px]">edit</span></a>
